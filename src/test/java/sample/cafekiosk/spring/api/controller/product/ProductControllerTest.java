...
public class ProductControllerTest {
    ...
    void getSellingProducts() throws Exception {
        ...
        when(productService.getSellingProducts()).thenReturn(result); // Mockito의 when() 사용
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.data").isArray()); // 조회 했을 때의 그 내용물은 하위 layer에서 테스트 끝났다고 가정, controller test에서는 그 형태만 검증한다.
    }
}
